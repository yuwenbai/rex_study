...
namespace UnityEditor.XCodeEditor
{
	public class XCBuildConfiguration : PBXObject
	{
		...
		public bool overwriteCapabilitySetting(string settingName, string settingValue) {
			Debug.Log ("overwriteCapabilitySetting " + settingName + " " + settingValue);
			bool modified = false;
		...
		public bool overwriteStringSetting(string settingName, string settingValue) {
			Debug.Log ("overwriteCodeSignSetting " + settingName + " " + settingValue);
			bool modified = false;

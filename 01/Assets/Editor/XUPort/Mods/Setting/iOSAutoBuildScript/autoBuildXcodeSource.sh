...
#将unity导出成xcode工程#
$UNITY_EXCUTE_PATH  quit -batchmode -projectPath ${UNITY_PATH} -executeMethod AutoBuidle.BuildIOS  -logFile $BUILD_PATH

...
/// 判断滑动方向
/// </summary>
public class CheckIsStopRecord : MonoBehaviour
{
    
   
  
    public delegate void UpSlider();
    public UpSlider Upslider;
    ...
    private void toAddFingerAction()
    {
        ...
        else if (fingerSegmentY == 0)
        {
            if (fingerSegmentX > 0)
            {
                projectQ.QLoger.LOG("right");
            }
            else
            {
                projectQ.QLoger.LOG("left");
            }
        }

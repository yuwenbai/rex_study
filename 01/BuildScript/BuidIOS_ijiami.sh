...
#打包Xcode工程
$UNITY_EXCUTE_PATH -batchmode -projectPath "$UNITY_PATH" -executeMethod AutoBuidle.BuildIOSIJM -logFile "$BUILD_PATH" -quit

echo "\033[32;1mxcode项目打包完毕 🚀 🚀 🚀  \033[0m"


#Xcode工程路径
XCODE_PROJECT_PATH=${UNITY_PATH}/Target/369mahjong_ios_ijiami
